...
class AssetViewController: UIViewController {
    ...
    @IBAction func removeAsset(_ sender: AnyObject) {
        let completion = { (success: Bool, error: Error?) -> () in
            if success {
                ...
                print("can't remove asset: \(String(describing: error))")//added String(describing here to fix warning
            }
        }
        ...
        if assetCollection != nil {
            ...
            PHPhotoLibrary.shared().performChanges({
                ...
                request.removeAssets([self.asset!] as NSArray)//added forced unwrapping here to fix warning
            }, completionHandler: completion)
        } else {
            // Delete asset from library
            PHPhotoLibrary.shared().performChanges({
                PHAssetChangeRequest.deleteAssets([self.asset!] as NSArray)//added force unwrapping here to fix warning
            }, completionHandler: completion)
        }
    ...
    @IBAction func toggleFavorite(_ sender: UIBarButtonItem) {
        PHPhotoLibrary.shared().performChanges({
            ...
            if success {
                ...
                print("can't set favorite: \(String(describing: error))")//added String(describing here to fix warning
            }
        })
    }
    ...
    func revertAsset(sender: UIAlertAction) {
        PHPhotoLibrary.shared().performChanges({
            ...
            if !success { print("can't revert asset: \(String(describing: error))") }//added String(describing here to fix warning
        })
    }
                ...
                DispatchQueue.global(qos: .userInitiated).async {
                    ...
                    applyFunc(filterName, input, output, {
                        ...
                        PHPhotoLibrary.shared().performChanges({
                            ...
                            if !success { print("can't edit asset: \(String(describing: error))") }//added String(describing here to fix warning
                        })
                    })
                }
            })
    ...
    func applyPhotoFilter(_ filterName: String, input: PHContentEditingInput, output: PHContentEditingOutput, completion: () -> ()) {
        ...
        let outputImage = inputImage
            ...
            //.applyingFilter(filterName, withInputParameters: nil) //compiler doesnt like passing nil into this method so commented out. coudlnt figure out why they were doing what they were doing since this was written in swift 3 but in swift 3 you must pass params into that method, not nil
    ...
    func applyLivePhotoFilter(_ filterName: String, input: PHContentEditingInput, output: PHContentEditingOutput, completion: @escaping () -> ()) {
        ...
        livePhotoContext.frameProcessor = { frame, _ in
            return frame.image/*frame.image.applyingFilter(filterName, withInputParameters: nil)*/ //compiler doesnt like passing nil into this method so commented out. coudlnt figure out why they were doing what they were doing since this was written in swift 3 but in swift 3 you must pass params into that method, not nil
        }
    ...
    func applyVideoFilter(_ filterName: String, input: PHContentEditingInput, output: PHContentEditingOutput, completion: @escaping () -> ()) {
        ...
        let composition = AVVideoComposition(
            ...
            applyingCIFiltersWithHandler: { request in
                let filtered = request.sourceImage//.applyingFilter(filterName, withInputParameters: nil) //compiler doesnt like passing nil into this method so commented out. coudlnt figure out why they were doing what they were doing since this was written in swift 3 but in swift 3 you must pass params into that method, not nil
